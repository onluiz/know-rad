...
<head>
    ...
    <!-- Service -->
    <script type="text/javascript" src="<c:url value='/assets/js/knowrad/doenca/doenca-service.js' />"></script>
    ...
    <!-- Controller -->
    <script type="text/javascript" src="<c:url value='/assets/js/knowrad/controller/config/doencas-controller.js' />"></script>

    <script>
        $(function() {
            UIDoencasController.init();
        });
    </script>
</head>
<body>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="termos">
                    ...
                    <a class="btn btn-info" href="#void" onclick="UIDoencasController.saveTermo();">Salvar Termo</a>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" onclick="UIDoencasController.saveOrUpdate();">Salvar</button>
                <button type="button" class="btn btn-default" onclick="UIDoencasController.closeModal();">Cancelar</button>
            </div>
        </div>
    </div>
</div>
